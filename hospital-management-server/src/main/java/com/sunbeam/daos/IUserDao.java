...
//delete employee using cell and userId
	...
	@Modifying
	@Query(value = "insert into users (id,first_name,last_name,email,password,cell_no,role,security_answer,security_question) values(:id,:firstName,:lastName,:email"
...
//(id,cell_no,email,first_name,last_name,password,role,security_answer,security_question) 
