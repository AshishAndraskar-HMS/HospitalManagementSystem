...
//	pat_id, medicine_id, prescription, medicine_qty
	@Modifying
	@Query(value= "insert into medicines_assigned (id,pat_id,medicine_id,prescription,medicine_qty) values(0, :patId,:medicineId,:prescription,:medicineQty)",nativeQuery = true)
