...
public interface IPatientDao extends JpaRepository<Patient,Integer> {
	...
	@Modifying
	@Query(value = "insert into patients (id,user_id,ward_id,doctor_id,date_of_admission,blood_group,dob,prescription,bed_alloted,payment_status,patient_problem)"
			+ " values (:id, :user_id, :ward_id, :doctor_id, :date_of_admission"
